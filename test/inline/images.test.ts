...
describe("inline/images", () => {
  ...
  it("Example 582: nested image in alt text", () => {
    ...
    const html = renderMarkdown(transformer, markdown);
    expect(html).toBe(
      '<p><img src="/url2" alt="foo bar" loading="lazy" /></p>\n',
    );
  });
  ...
  it("Example 592: collapsed reference image", () => {
    ...
    const html = renderMarkdown(transformer, markdown);
    expect(html).toBe(
      '<p><img src="/url" alt="foo" title="title" loading="lazy" /></p>\n',
    );
  });
  ...
  it("Example 593: collapsed reference image with emphasis in label", () => {
    ...
    const html = renderMarkdown(transformer, markdown);
    expect(html).toBe(
      '<p><img src="/url" alt="foo bar" title="title" loading="lazy" /></p>\n',
    );
  });
  ...
  it("Example 595: collapsed reference image with whitespace", () => {
    ...
    const html = renderMarkdown(transformer, markdown);
    expect(html).toBe(
      '<p><img src="/url" alt="foo" title="title" loading="lazy" />\n[]</p>\n',
    );
  });
