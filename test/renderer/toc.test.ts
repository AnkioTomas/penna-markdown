...
describe("renderer/toc/extract", () => {
  const ast = createNode("document", 0, undefined, [
    ...
    createNode("atx_heading", 8, undefined, [createNode("text", 4, "Setup", undefined)], { level: 2 }),
    createNode("atx_heading", 7, undefined, [createNode("text", 3, "API", undefined)], { level: 2 }),
    createNode("atx_heading", 9, undefined, [createNode("text", 5, "Details", undefined)], { level: 3 }),
  ]);
