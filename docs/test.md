...
export default defineConfig({
  optimizeDeps: {
    include: [
      "cherry-markdown-next/transformer",
      "cherry-markdown-next/renderer",
    ],
  },
});
```
...
_附录结束 · Cherry Markdown Next 技术白皮书 Draft · 仓库 [[repo]] · :sparkles:_
...
_Cherry Markdown Next · [[description]] · 仓库 [[repo]] · :sparkles:_
